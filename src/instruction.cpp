...
namespace clara {
    namespace instruction {
        ...
        void Instruction::set_if_condition(Condition if_condition) {
            this->if_condition = if_condition;
        }

        std::set<statement::Statement> Instruction::get_if_cond_statements() {
        ...
        void Instruction::set_else_if_condition(Condition else_if_condition) {
            this->else_if_condition = else_if_condition;
        }

        std::set<statement::Statement> Instruction::get_else_if_cond_statements() {
        ...
        std::set<statement::Statement> Instruction::get_else_cond_statements() {
            return else_if_cond_statements;
        }
        ...
        std::set<statement::Statement> Instruction::get_un_cond_statements() {
            return un_cond_statements;
        }

        void Instruction::set_un_cond_statements(std::set<statement::Statement> un_cond_statements) {
        ...
        bool Instruction::equals(Instruction i) {
            ...
            if (this->if_condition != i.if_condition) {
                return false;
            }
            ...
            if (this->else_if_condition != i.else_if_condition) {
                return false;
            }
